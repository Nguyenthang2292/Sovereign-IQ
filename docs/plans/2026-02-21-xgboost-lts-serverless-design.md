...
- [ ] Implement basic S3 client

### Phase 2: Feature Engine (Week 2-3)
- [ ] Implement price-derived features (5 features)
- [ ] Implement moving averages (3 features)
- [ ] Implement RSI family (3 features)
- [ ] Implement MACD (3 features)
- [ ] Implement volatility indicators (2 features)
- [ ] Implement volume indicators (2 features)
- [ ] Implement advanced features (12 features)
- [ ] Implement all 48 candlestick patterns
- [ ] Implement lag features (9 features)
- [ ] Write feature parity tests

### Phase 3: XGBoost Integration (Week 4)
- [ ] Integrate xgboost-rs crate
- [ ] Implement model loading from JSON
...
- [ ] Document all 92 features
- [ ] Write AWS setup guide
- [ ] Write model export guide
