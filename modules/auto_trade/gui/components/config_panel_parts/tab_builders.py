...
def create_risk_settings_tab(panel):
    ...
    container = ctk.CTkFrame(tab, fg_color=Colors.TRANSPARENT)
    container.pack(fill="both", expand=True, padx=5, pady=5)
    container.grid_columnconfigure(0, weight=1)
    container.grid_columnconfigure(1, weight=1)

    risk_box = ctk.CTkFrame(container, fg_color=Colors.get_card_bg(), corner_radius=0)
    risk_box.grid(row=0, column=0, sticky="nsew", padx=(0, 5))
    risk_frame = ctk.CTkFrame(risk_box, fg_color=Colors.TRANSPARENT)
    risk_frame.pack(fill="both", expand=True, padx=15, pady=15)

    ctk.CTkLabel(risk_frame, text="Risk Management", font=Fonts.H2).pack(anchor="w", pady=(0, 15))
    ...
    ctk.CTkLabel(risk_frame, text="Max Position Size ($):", font=Fonts.INPUT).pack(anchor="w", pady=(5, 2))
    ...
    ctk.CTkLabel(risk_frame, text="Max Open Positions:", font=Fonts.INPUT).pack(anchor="w", pady=(5, 2))
    ...
    ctk.CTkLabel(risk_frame, text="Max Daily Loss ($):", font=Fonts.INPUT).pack(anchor="w", pady=(5, 2))
    ...
    ctk.CTkLabel(risk_frame, text="Default Leverage:", font=Fonts.INPUT).pack(anchor="w", pady=(5, 2))
    ...
    tp_sl_box = ctk.CTkFrame(container, fg_color=Colors.get_card_bg(), corner_radius=0)
    tp_sl_box.grid(row=0, column=1, sticky="nsew", padx=5)
    tp_sl_inner = ctk.CTkFrame(tp_sl_box, fg_color=Colors.TRANSPARENT)
    tp_sl_inner.pack(fill="both", expand=True, padx=15, pady=15)

    ctk.CTkLabel(tp_sl_inner, text="TP/SL Configuration", font=Fonts.H2).pack(anchor="w", pady=(0, 15))

    ctk.CTkLabel(tp_sl_inner, text="Default Take Profit (%):", font=Fonts.INPUT).pack(anchor="w", pady=(5, 2))
    ...
    ctk.CTkLabel(tp_sl_inner, text="Default Stop Loss (%):", font=Fonts.INPUT).pack(anchor="w", pady=(5, 2))
    ...
    ctk.CTkLabel(tp_sl_inner, text="TP/SL Mode:", font=Fonts.INPUT).pack(anchor="w", pady=(5, 2))
    ...
    ctk.CTkLabel(tp_sl_inner, text="Trailing Step (%):", font=Fonts.INPUT).pack(anchor="w", pady=(10, 2))
    ...
    panel.max_steps_label = ctk.CTkLabel(tp_sl_inner, text="Max Steps:", font=Fonts.INPUT)
    panel.max_steps_entry = ctk.CTkEntry(tp_sl_inner, placeholder_text="5")
    panel.max_steps_entry.insert(0, "5")

    separator = ctk.CTkLabel(tp_sl_inner, text="─────────────────────────", text_color=Colors.TEXT_MUTED)
...
def create_auto_close_timer_tab(panel):
    ...
    auto_close_box = ctk.CTkFrame(container, fg_color=Colors.get_card_bg(), corner_radius=0)
    auto_close_box.grid(row=0, column=0, sticky="nsew")

    auto_close_inner = ctk.CTkFrame(auto_close_box, fg_color=Colors.TRANSPARENT)
...
def create_api_keys_tab(panel):
    ...
    api_frame = ctk.CTkFrame(tab, fg_color=Colors.TRANSPARENT)
    api_frame.pack(fill="both", expand=True, padx=10, pady=10)

    ctk.CTkLabel(api_frame, text="Trading Mode:", font=Fonts.INPUT).pack(anchor="w", pady=(5, 2))
    panel.mode_var = ctk.StringVar(value="DRY_RUN")

    mode_frame = ctk.CTkFrame(api_frame, fg_color=Colors.TRANSPARENT)
    ...
    panel.mode_description_label = ctk.CTkLabel(
        ...
        image=get_icon("shield_check", size=(16, 16)),
        compound="left",
    )
    panel.mode_description_label.pack(anchor="w", pady=(2, 10))

    ctk.CTkLabel(api_frame, text="Exchange:", font=Fonts.INPUT).pack(anchor="w", pady=(5, 2))
    ...
    panel.api_key_frame = ctk.CTkFrame(api_frame, fg_color=Colors.TRANSPARENT)
    panel.api_key_frame.pack(fill="x")

    panel.credentials_masked_frame = ctk.CTkFrame(panel.api_key_frame, fg_color=Colors.TRANSPARENT)
    ctk.CTkLabel(panel.credentials_masked_frame, text="API Key:", font=Fonts.INPUT).pack(anchor="w", pady=(10, 2))
    panel.api_key_masked_label = ctk.CTkLabel(panel.credentials_masked_frame, text="—", font=Fonts.H3)
    panel.api_key_masked_label.pack(anchor="w", pady=2)
    ctk.CTkLabel(panel.credentials_masked_frame, text="API Secret:", font=Fonts.INPUT).pack(anchor="w", pady=(10, 2))
    panel.api_secret_masked_label = ctk.CTkLabel(panel.credentials_masked_frame, text="—", font=Fonts.H3)
    ...
    change_btn = ctk.CTkButton(
        ...
        fg_color=Colors.WARNING_BRIGHT,
        text_color=Colors.WHITE,
        hover_color=Colors.WARNING_DIM,
        command=panel._on_change_credentials,
        image=get_button_icon("pencil", size=(16, 16), variant="warning"),
        compound="left",
    )
    change_btn.pack(anchor="w", pady=(20, 5))

    panel.credentials_entry_frame = ctk.CTkFrame(panel.api_key_frame, fg_color=Colors.TRANSPARENT)
    panel.credentials_entry_frame.pack(fill="x")

    ctk.CTkLabel(panel.credentials_entry_frame, text="API Key:", font=Fonts.INPUT).pack(anchor="w", pady=(10, 2))
    ...
    ctk.CTkLabel(panel.credentials_entry_frame, text="API Secret:", font=Fonts.INPUT).pack(anchor="w", pady=(10, 2))
    ...
    entry_buttons_frame = ctk.CTkFrame(panel.credentials_entry_frame, fg_color=Colors.TRANSPARENT)
    ...
    test_btn = ctk.CTkButton(
        ...
        image=get_button_icon("link", size=(16, 16), variant="success"),
        compound="left",
    )
    ...
    save_btn = ctk.CTkButton(
        ...
        image=get_button_icon("save", size=(16, 16), variant="primary"),
        compound="left",
    )
    ...
    panel.cancel_credentials_btn = ctk.CTkButton(
        ...
        hover_color=Colors.DANGER_ALT_HOVER,
        command=panel._on_cancel_credentials,
        image=get_button_icon("x", size=(16, 16), variant="danger"),
        compound="left",
    )
