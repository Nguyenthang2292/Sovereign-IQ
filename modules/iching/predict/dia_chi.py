...
class DiaChi:
    ...
    def is_luc_hop(cls, chi1: str, chi2: str) -> bool:
        ...
        return (
            (chi1 in LUC_HOP_DICT and LUC_HOP_DICT[chi1] == chi2) or
    ...
    def is_luc_xung(cls, chi1: str, chi2: str) -> bool:
        ...
        # Kiểm tra cả hai chiều (chi1-chi2 và chi2-chi1)
        return (
            (chi1 in LUC_XUNG_DICT and LUC_XUNG_DICT[chi1] == chi2) or
...
DIA_CHI_DICT: Dict[str, DiaChi] = {
    dc.name: dc for dc in DIA_CHI_LIST
}
