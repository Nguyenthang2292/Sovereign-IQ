...
def display_backtest_results(
    result: dict, symbol: str, signal_mode: str = "single_signal", signal_calculation_mode: str = "precomputed"
) -> None:
    """
    ...
    if total_time > 0:
        ...
        try:
            ...
            if ENABLE_PARALLEL_PROCESSING and SHARED_MEMORY_AVAILABLE:
                ...
                print("  • Parallel Processing: Enabled with pickle serialization")
            else:
                print("  • Sequential Processing: Vectorized (optimized)")
        except ImportError:
    ...
    if trades:
        ...
        for i, trade in enumerate(recent_trades, 1):
            ...
            print(
                f"{i}. Entry: {trade.get('entry_time', 'N/A')} | "
...
def main() -> None:
    ...
    if signal_mode == "single_signal":
        print("    └─ Using single signal (highest confidence) approach - Lấy bất kỳ signal nào có confidence cao nhất")
    else:
