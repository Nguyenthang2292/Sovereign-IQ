...
def generate_signals_sustained_strategy(
    ...
    *,
    ...
    if debug_enabled:
        log_analysis("[Strategy2] Starting sustained pressure signal generation")
        log_debug(
            f"[Strategy2] Parameters: min_bars_above={min_bars_above_zero}, "
    ...
    if debug_enabled:
        ...
        log_debug(f"[Strategy2] Initial signals: LONG={long_count}, SHORT={short_count}, conflicts={conflict_count}")
    ...
    if debug_enabled:
        ...
        log_analysis(
            f"[Strategy2] Final signals: LONG={final_long}, SHORT={final_short}, "
