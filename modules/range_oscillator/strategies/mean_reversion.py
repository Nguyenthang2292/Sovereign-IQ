...
def generate_signals_mean_reversion_strategy(
    ...
    *,
    ...
    if debug_enabled:
        log_analysis("[Strategy9] Starting mean reversion signal generation")
        log_debug(
            f"[Strategy9] Parameters: extreme_threshold={extreme_threshold}, "
    ...
    if debug_enabled:
        ...
        log_debug(
            f"[Strategy9] Transitions detected: from_positive={transition_positive_count}, "
    ...
    if debug_enabled:
        ...
        log_analysis(
            f"[Strategy9] Final signals: LONG={final_long}, SHORT={final_short}, "
