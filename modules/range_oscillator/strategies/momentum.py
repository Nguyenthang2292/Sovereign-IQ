...
def generate_signals_momentum_strategy(
    ...
    *,
    ...
    if debug_enabled:
        log_analysis("[Strategy4] Starting momentum signal generation")
        log_debug(f"[Strategy4] Parameters: momentum_period={momentum_period}, momentum_threshold={momentum_threshold}")
    ...
    if debug_enabled:
        ...
        log_debug(f"[Strategy4] Initial signals: LONG={long_count}, SHORT={short_count}, conflicts={conflict_count}")
    ...
    if debug_enabled:
        ...
        log_analysis(
            f"[Strategy4] Final signals: LONG={final_long}, SHORT={final_short}, "
