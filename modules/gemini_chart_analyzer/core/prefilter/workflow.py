...
def run_prefilter_worker(
    ...
    try:
        ...
        if atc_performance:
            ...
            # Standard config keys: batch_processing, use_cuda, parallel_l1, parallel_l2, use_cache, fast_mode
            # Args expected by VotingAnalyzer/ATCAnalyzer:
            ...
            # - use_cache: bool
            # - fast_mode: bool
            # - use_rust_backend: bool (often mapped from batch_processing or separate)

            # Map standard config to args
        ...
        # Use symbols_to_process (after Stage 0 sampling)
