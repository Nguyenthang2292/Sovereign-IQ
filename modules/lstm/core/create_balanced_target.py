...
from modules.common.ui.logging import log_warn, log_debug, log_error
...
def create_balanced_target(df, threshold=TARGET_THRESHOLD_LSTM, neutral_zone=NEUTRAL_ZONE_LSTM):
    ...
    try:
        ...
        rng = np.random.default_rng(42)  # Local generator with fixed seed ensures deterministic results for label assignment
