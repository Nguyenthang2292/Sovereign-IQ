...
from modules.lstm.models.lstm_models import (
...
ATTENTION_ALLOWED_KEYS = {
    'num_heads', 'dropout', 'hidden_size', 'num_layers', 
    'num_classes', 'use_positional_encoding', 'output_mode'
}
ENCODER_ALLOWED_KEYS = {
    'dropout', 'hidden_size', 'num_layers', 'num_classes', 'output_mode'
}
CNN_ALLOWED_KEYS = {
    'cnn_features', 'lstm_hidden', 'num_layers', 'num_classes',
    'num_heads', 'dropout', 'use_positional_encoding', 'output_mode'
}
