...
from modules.common.ui.logging import log_info, log_error, log_warn, log_debug, log_model
from modules.common.utils.system import PyTorchGPUManager
from modules.common.utils.data import validate_ohlcv_input, fetch_ohlcv_data_dict
...
def test_signal_generation(config: ModelConfiguration, 
                            model: object, 
                            test_symbol: str, 
                            test_timeframe: str, 
                            all_symbols_ohlcv_data: Dict) -> str:
    """
    ...
    try:
        ...
        # Get test data
        test_df = None
        if (all_symbols_ohlcv_data and 
            test_symbol in all_symbols_ohlcv_data and 
            all_symbols_ohlcv_data[test_symbol] and
            isinstance(all_symbols_ohlcv_data[test_symbol], dict) and
            test_timeframe in all_symbols_ohlcv_data[test_symbol]):
        ...
        missing_columns = [col for col in ["timestamp", "open", "high", "low", "close", "volume"] if col not in test_df.columns]
