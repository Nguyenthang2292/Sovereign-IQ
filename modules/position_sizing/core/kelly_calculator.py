...
class BayesianKellyCalculator:
    ...
    def calculate_kelly_fraction(
        ...
        try:
            ...
            use_posterior_mean = lower_bound < KELLY_MIN_LOWER_BOUND_THRESHOLD or (
                num_trades < KELLY_SMALL_SAMPLE_SIZE and lower_bound < posterior_mean * KELLY_LOWER_BOUND_MEAN_RATIO
            )
