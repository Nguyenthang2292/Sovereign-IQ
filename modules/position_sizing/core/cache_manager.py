...
class CacheManagerMixin:
    ...
    def _init_cache(self):
        ...
        self._data_cache: OrderedDict[Tuple[str, int, str, Optional[str]], Tuple[pd.DataFrame, Optional[str]]] = OrderedDict()
    ...
    def _cache_data_result(self, cache_key: Tuple[str, int, str], result: pd.DataFrame, exchange_id: Optional[str] = None):
        """
