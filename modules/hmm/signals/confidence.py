...
def calculate_kama_confidence(score_long: float, score_short: float) -> float:
    """
...
def calculate_combined_confidence(
    ...
    base_confidence = high_order_prob * HMM_HIGH_ORDER_WEIGHT + kama_confidence * HMM_KAMA_WEIGHT
