...
# Feature Flags (grouped for better organization)
HMM_FEATURES = {
...
# High-Order HMM Scoring Configuration (grouped as dict)
...
# Dynamic Threshold Configuration (grouped as dict)
...
# State Strength Multipliers Configuration (grouped as dict)
HMM_STATE_STRENGTH = {
