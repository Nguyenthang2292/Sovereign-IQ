...
from modules.common.ui.logging import log_error, log_warn, log_debug
...
def fetch_ohlcv_data_dict(
    ...
    if error_count:
        log_warn(f"fetch_ohlcv_data_dict completed with {error_count} error(s) for symbols {symbols} and timeframes {timeframes}")
