...
This is a general-purpose half-life calculation that can be used
...
def calculate_half_life(spread: pd.Series) -> Optional[float]:
    ...
    **Interpretation**:
    ...
    try:
        ...
        if half_life < 0 or np.isinf(half_life) or np.isnan(half_life) or half_life > PAIRS_TRADING_MAX_HALF_LIFE:
            return None
