...
This is a general-purpose Sharpe ratio calculation that can be used
...
def calculate_sharpe_ratio(
    pnl_series: pd.Series, periods_per_year: int = PAIRS_TRADING_PERIODS_PER_YEAR, risk_free_rate: float = 0.0
) -> Optional[float]:
    """
    ...
    **Interpretation**:
    ...
    Example:
        ...
        >>> sharpe = calculate_sharpe_ratio(pnl_series, periods_per_year=252)
