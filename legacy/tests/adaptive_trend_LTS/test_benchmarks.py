...
try:
    from modules.adaptive_trend_LTS_mini.benchmarks.benchmark_dask_memory import (
        benchmark_memory_usage,
        generate_test_data,
        get_memory_usage_mb,
    )
    from modules.adaptive_trend_LTS_mini.benchmarks.benchmark_dask_speed import (
        benchmark_speed,
