"""Crossunder detection function for signal generation.

This module provides the crossunder function to detect downward crossovers
between two series (equivalent to Pine Script ta.crossunder).
"""
    ...
    try:
        ...
        if not series_a.index.equals(series_b.index):
            ...
            if len(common_index) == 0:
                ...
                return pd.Series(dtype="bool", index=common_index)
