...
from modules.adaptive_trend_LTS_mini.core.compute_atc_signals.incremental_mas_o1 import TrueO1WMA, TrueO1HMA, TrueO1LSMA, TrueO1KAMA
...
def main():
    ...
    print(f"  - All O(1) implementations use constant-time updates (no window iteration)")
    print(f"  - Expected speedup should be 2-5x for affected MAs (WMA, HMA, LSMA, KAMA)")
