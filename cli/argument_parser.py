...
def parse_args(mode="hybrid", force_enable_spc=True, force_enable_decision_matrix=True):
    ...
    parser.add_argument(
        "--max-symbols", type=int, default=None, help="Maximum number of symbols to scan (default: None = all)"
    )
    parser.add_argument("--osc-length", type=int, default=50, help="Range Oscillator length parameter (default: 50)")
    parser.add_argument("--osc-mult", type=float, default=2.0, help="Range Oscillator multiplier (default: 2.0)")
    parser.add_argument(
        "--max-workers",
        type=int,
        default=10,
