...
from web.shared.utils.translations import get_locale_from_header, translate
...
async def get_logs(
    ...
    command_type: Literal["scan", "analyze"] = Query("scan", description="Type of command: 'scan' or 'analyze'"),
):
    """
    ...
    try:
        ...
        log_content, new_offset = log_manager.read_log(session_id, offset, command_type)
