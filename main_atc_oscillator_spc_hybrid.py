...
def parse_args():
    ...
    # Force enable SPC and Decision Matrix (required for this workflow)
    # Note: We parse the flags correctly (without default=True conflict),
    # then enforce the requirement that these features are always enabled
