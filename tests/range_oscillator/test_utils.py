...
class TestGetOscillatorData:
    ...
    def test_get_oscillator_data_with_ohlc(self, sample_ohlc_data):
        ...
        oscillator, ma, range_atr = get_oscillator_data(high=high, low=low, close=close, length=50, mult=2.0)
        ...
        for length in [20, 50, 100]:
            for mult in [1.5, 2.0, 3.0]:
                oscillator, ma, range_atr = get_oscillator_data(
                    high=high, low=low, close=close, length=length, mult=mult
                )
    ...
    def test_get_oscillator_data_empty_series(self):
        ...
        with pytest.raises((ValueError, IndexError)):
            get_oscillator_data(high=empty_series, low=empty_series, close=empty_series)
    ...
    def test_get_oscillator_data_index_mismatch(self):
        ...
        with pytest.raises(ValueError, match="must have the same index"):
            get_oscillator_data(oscillator=oscillator, ma=ma, range_atr=range_atr)
