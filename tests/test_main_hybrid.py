...
class TestHelperFunctionsHybrid:
    ...
    def test_get_range_oscillator_signal_success(self, mock_data_fetcher):
        ...
        with patch("core.signal_calculators.generate_signals_combined_all_strategy") as mock_gen:
            ...
            result = get_range_oscillator_signal(mock_data_fetcher, "BTC/USDT", "1h", 500)
    ...
    def test_get_spc_signal_success(self, mock_data_fetcher):
        ...
        with (
            patch("core.signal_calculators.SimplifiedPercentileClustering") as mock_spc,
            ...
            result = get_spc_signal(mock_data_fetcher, "BTC/USDT", "1h", 500, "cluster_transition")
    ...
    def test_get_hmm_signal_success(self, mock_data_fetcher):
        ...
        with patch("core.signal_calculators.combine_signals") as mock_hmm:
            from modules.hmm.signals.resolution import HOLD, LONG
            ...
            result = get_hmm_signal(mock_data_fetcher, "BTC/USDT", "1h", 500)
