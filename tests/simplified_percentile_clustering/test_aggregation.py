...
class TestSPCVoteAggregator:
    ...
    def test_config_simple_mode(self):
        ...
        config = SPCAggregationConfig(mode="simple", enable_simple_fallback=False, simple_min_accuracy_total=1.2)
    ...
    def test_aggregate_weighted_mode(self):
        ...
        config = SPCAggregationConfig(mode="weighted", weighted_min_total=0.5, weighted_min_diff=0.1)
        aggregator = SPCVoteAggregator(config)
    ...
    def test_aggregate_adaptive_weights(self):
        ...
        vote, strength, confidence = aggregator.aggregate(
            symbol_data, "LONG", signals_history=signals_history, strengths_history=strengths_history
        )
    ...
    def test_aggregate_simple_mode_direct_long(self):
        ...
        config = SPCAggregationConfig(mode="simple", simple_min_accuracy_total=1.5)
        aggregator = SPCVoteAggregator(config)
    ...
    def test_aggregate_simple_mode_mixed_signals_long_wins(self):
        ...
        config = SPCAggregationConfig(mode="simple", simple_min_accuracy_total=1.0)
        aggregator = SPCVoteAggregator(config)
    ...
    def test_aggregate_simple_mode_equal_accuracy_prefers_long(self):
        ...
        config = SPCAggregationConfig(mode="simple", simple_min_accuracy_total=0.5)
        aggregator = SPCVoteAggregator(config)
    ...
    def test_aggregate_simple_mode_with_custom_weights(self):
        ...
        config = SPCAggregationConfig(mode="simple", strategy_weights=custom_weights, simple_min_accuracy_total=1.5)
        aggregator = SPCVoteAggregator(config)
    ...
    def test_aggregate_simple_fallback_strength_calculation(self):
        ...
        config = SPCAggregationConfig(
            mode="weighted", weighted_min_total=0.9, enable_simple_fallback=True, simple_min_accuracy_total=1.0
        )
        aggregator = SPCVoteAggregator(config)
