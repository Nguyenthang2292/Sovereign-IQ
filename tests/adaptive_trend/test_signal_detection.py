...
def test_crossover_detects_upward_cross():
    ...
    assert not result.iloc[0]  # 10 <= 11, 10 <= 11
    assert not result.iloc[1]  # 10 <= 11, 10 <= 11
    assert result.iloc[2]  # 12 > 11 AND 10 <= 11 (crossover!)
    assert not result.iloc[3]  # 13 > 11 BUT 12 > 11 (already crossed)
...
def test_crossunder_detects_downward_cross():
    ...
    assert len(result) == len(series_a)
    assert not result.iloc[0]  # 12 >= 11, 12 >= 11
    assert not result.iloc[1]  # 12 >= 11, 12 >= 11
    assert result.iloc[2]  # 10 < 11 AND 12 >= 11 (crossunder!)
    assert not result.iloc[3]  # 9 < 11 BUT 10 < 11 (already crossed)
