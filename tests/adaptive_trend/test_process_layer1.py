...
def test_layer1_signal_for_ma_basic():
    ...
    ma_tuple = (ma_base, ma_base, ma_base, ma_base, ma_base, ma_base, ma_base, ma_base, ma_base)

    signal_series, signals_tuple, equity_tuple = _layer1_signal_for_ma(prices, ma_tuple, L=0.02, De=0.03, cutout=0)
...
def test_layer1_signal_for_ma_with_cutout():
    ...
    signal_series, _, _ = _layer1_signal_for_ma(prices, ma_tuple, L=0.02, De=0.03, cutout=0)
