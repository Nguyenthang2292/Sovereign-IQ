...
def ensure_vue_catchall_route():
    ...
    route_exists = any(hasattr(r, "path") and r.path == "/{full_path:path}" for r in app.routes)
...
class TestVueAppServing:
    ...
    def test_batch_results_routed_to_api_router(self, client, tmp_path):
        ...
        with (
            ...
            assert any(msg in detail for msg in ["Results file not found", "Invalid filename or file does not exist"])
