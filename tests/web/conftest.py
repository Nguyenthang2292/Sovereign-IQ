...
def _setup_common_mocks(sample_ohlcv_df, tmp_path, mock_data_fetcher_class, 
                        mock_log_mgr, mock_task_mgr):
    """
...
def chart_analyzer_mocks(sample_ohlcv_df, tmp_path):
    ...
    with patch('web.api.chart_analyzer.ExchangeManager') as mock_exchange, \
