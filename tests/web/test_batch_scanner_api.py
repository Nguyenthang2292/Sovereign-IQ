...
class TestBatchScanEndpoint:
    ...
    def test_success_single_timeframe_mode(self, client, tmp_path):
        ...
        with patch('web.api.batch_scanner.MarketBatchScanner') as mock_scanner_class, \
    ...
    def test_success_multi_timeframe_mode(self, client, tmp_path):
        ...
        with patch('web.api.batch_scanner.MarketBatchScanner') as mock_scanner_class, \
            ...
            with patch('modules.gemini_chart_analyzer.core.utils.chart_paths.get_analysis_results_dir', return_value=tmp_path), \
    ...
    def test_valid_paths_should_pass(self, client, tmp_path):
        ...
        with patch('modules.gemini_chart_analyzer.core.utils.chart_paths.get_analysis_results_dir', return_value=tmp_path):
            ...
            for filename, content in valid_cases:
                ...
                data = response.json()
                assert data["success"] is True, \
                    f"Expected success=True for valid path '{filename}'"
