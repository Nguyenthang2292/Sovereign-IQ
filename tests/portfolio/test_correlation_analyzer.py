...
def main():
    ...
    try:
        ...
        portfolio_return_corr, metadata = analyzer.calculate_portfolio_return_correlation(new_symbol, verbose=True)
        ...
        impact = analyzer.analyze_correlation_with_new_symbol(
            new_symbol=new_symbol, new_position_size=800.0, new_direction="LONG", verbose=True
        )
