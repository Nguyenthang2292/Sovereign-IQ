...
from modules.auto_trade.gui.utils.toast import ToastNotification, show_toast
...
class TestToastNotification:
    ...
    def test_show_toast_info(self, mock_parent):
        ...
        with patch("modules.auto_trade.gui.utils.toast.ToastNotification") as mock_toast:
            show_toast(mock_parent, "Info message", type="info")

            mock_toast.assert_called_once_with(mock_parent, "Info message", 3000, fg_color="#333333")
    ...
    def test_show_toast_success(self, mock_parent):
        ...
        with patch("modules.auto_trade.gui.utils.toast.ToastNotification") as mock_toast:
            ...
            mock_toast.assert_called_once_with(mock_parent, "Success message", 3000, fg_color="#228822")
    ...
    def test_show_toast_error(self, mock_parent):
        ...
        with patch("modules.auto_trade.gui.utils.toast.ToastNotification") as mock_toast:
            ...
            mock_toast.assert_called_once_with(mock_parent, "Error message", 3000, fg_color="#aa2222")
    ...
    def test_show_toast_warning(self, mock_parent):
        ...
        with patch("modules.auto_trade.gui.utils.toast.ToastNotification") as mock_toast:
            ...
            mock_toast.assert_called_once_with(mock_parent, "Warning message", 3000, fg_color="#aa8822")
    ...
    def test_show_toast_custom_duration(self, mock_parent):
        ...
        with patch("modules.auto_trade.gui.utils.toast.ToastNotification") as mock_toast:
            ...
            mock_toast.assert_called_once_with(mock_parent, "Message", 5000, fg_color="#333333")
    ...
    def test_show_toast_unknown_type(self, mock_parent):
        ...
        with patch("modules.auto_trade.gui.utils.toast.ToastNotification") as mock_toast:
            ...
            mock_toast.assert_called_once_with(mock_parent, "Message", 3000, fg_color="#333333")
