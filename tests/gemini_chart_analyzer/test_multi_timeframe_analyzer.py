...
def default_analyzer():
    """Create MultiTimeframeAnalyzer with default weights."""
    return MultiTimeframeAnalyzer()


@pytest.fixture
def custom_analyzer():
    """Create MultiTimeframeAnalyzer with custom weights."""
    custom_weights = {
        '15m': 0.2,
        '1h': 0.3,
        '4h': 0.5
    }
    return MultiTimeframeAnalyzer(timeframe_weights=custom_weights)
...
class TestMultiTimeframeAnalyzerInit:
    ...
    def test_init_default_weights(self, default_analyzer):
        ...
        assert '15m' in default_analyzer.timeframe_weights or \
               '1h' in default_analyzer.timeframe_weights
