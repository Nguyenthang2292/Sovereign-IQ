...
class TestChartGeneratorInit:
    ...
    def test_init_custom_params(self):
        ...
        generator = ChartGenerator(figsize=(20, 12), style="default", dpi=200)
...
class TestChartGeneratorCreateChart:
    ...
    def test_create_chart_basic(self, chart_generator, sample_ohlcv_data, temp_output_dir):
        ...
        result_path = chart_generator.create_chart(
            df=sample_ohlcv_data, symbol="BTC/USDT", timeframe="1h", output_path=str(output_path)
        )
    ...
    def test_create_chart_with_ma(self, chart_generator, sample_ohlcv_data, temp_output_dir):
        ...
        result_path = chart_generator.create_chart(
            df=sample_ohlcv_data, symbol="BTC/USDT", timeframe="1h", indicators=indicators, output_path=str(output_path)
        )
    ...
    def test_create_chart_with_rsi(self, chart_generator, sample_ohlcv_data, temp_output_dir):
        ...
        result_path = chart_generator.create_chart(
            df=sample_ohlcv_data, symbol="ETH/USDT", timeframe="4h", indicators=indicators, output_path=str(output_path)
        )
    ...
    def test_create_chart_auto_output_path(self, chart_generator, sample_ohlcv_data, tmp_path):
        ...
        try:
            ...
            result_path = chart_generator.create_chart(df=sample_ohlcv_data, symbol="BTC/USDT", timeframe="1h")
    ...
    def test_create_chart_no_volume(self, chart_generator, sample_ohlcv_data, temp_output_dir):
        ...
        result_path = chart_generator.create_chart(
            df=sample_ohlcv_data, symbol="BTC/USDT", timeframe="1h", show_volume=False, output_path=str(output_path)
        )
    ...
    def test_create_chart_empty_dataframe(self, chart_generator, temp_output_dir):
        ...
        with pytest.raises(ValueError, match="Empty DataFrame, cannot create chart"):
            chart_generator.create_chart(df=empty_df, symbol="BTC/USDT", timeframe="1h", output_path=str(output_path))
    ...
    def test_create_chart_missing_columns(self, chart_generator, temp_output_dir):
        ...
        with pytest.raises(ValueError, match="Missing columns"):
            chart_generator.create_chart(df=df, symbol="BTC/USDT", timeframe="1h", output_path=str(output_path))
    ...
    def test_create_chart_with_timestamp_column(self, chart_generator, temp_output_dir):
        ...
        result_path = chart_generator.create_chart(
            df=df, symbol="BTC/USDT", timeframe="1h", output_path=str(output_path)
        )
