...
def batch_generator():
    ...
    return ChartBatchGenerator(charts_per_batch=100, grid_rows=10, grid_cols=10, chart_size=(2.0, 1.5), dpi=100)
...
class TestChartBatchGeneratorInit:
    ...
    def test_init_custom_params(self):
        ...
        generator = ChartBatchGenerator(charts_per_batch=25, grid_rows=5, grid_cols=5, chart_size=(3.0, 2.0), dpi=150)
    ...
    def test_init_invalid_chart_size_raises_error(self):
        ...
        with pytest.raises(ValueError, match="chart_size.*positive"):
            ChartBatchGenerator(charts_per_batch=100, grid_rows=10, grid_cols=10, chart_size=(0.0, 1.5))

        # Test with negative height
        with pytest.raises(ValueError, match="chart_size.*positive"):
            ChartBatchGenerator(charts_per_batch=100, grid_rows=10, grid_cols=10, chart_size=(2.0, -1.5))

        # Test with non-tuple type (string)
        with pytest.raises(ValueError, match="tuple or list of 2 elements"):
            ChartBatchGenerator(charts_per_batch=100, grid_rows=10, grid_cols=10, chart_size="invalid")

        # Test with non-tuple type (int)
        with pytest.raises(ValueError, match="tuple or list of 2 elements"):
            ChartBatchGenerator(charts_per_batch=100, grid_rows=10, grid_cols=10, chart_size=5)

    def test_init_invalid_dpi_raises_error(self):
        """Test initialization with invalid dpi values raises error."""
        # Test with zero dpi
        with pytest.raises(ValueError, match="positive"):
            ChartBatchGenerator(charts_per_batch=100, grid_rows=10, grid_cols=10, dpi=0)

        # Test with negative dpi
        with pytest.raises(ValueError, match="positive"):
            ChartBatchGenerator(charts_per_batch=100, grid_rows=10, grid_cols=10, dpi=-100)
...
class TestChartBatchGeneratorCreateBatchChart:
    ...
    def test_create_batch_chart_basic(self, batch_generator, multiple_symbols_data, tmp_path):
        ...
        result_path, truncated = batch_generator.create_batch_chart(
            symbols_data=multiple_symbols_data, timeframe="1h", output_path=str(output_path), batch_id=1
        )
    ...
    def test_create_batch_chart_auto_path(self, batch_generator, multiple_symbols_data, tmp_path, monkeypatch):
        ...
        result_path, truncated = batch_generator.create_batch_chart(
            symbols_data=multiple_symbols_data[:5], timeframe="1h", batch_id=1
        )
    ...
    def test_create_batch_chart_too_many_symbols(self, batch_generator, multiple_symbols_data, tmp_path):
        ...
        many_symbols = [{"symbol": f"SYM{i}/USDT", "df": multiple_symbols_data[0]["df"]} for i in range(150)]

        output_path = tmp_path / "batch_chart_many.png"
        result_path, truncated = batch_generator.create_batch_chart(
            symbols_data=many_symbols, timeframe="1h", output_path=str(output_path)
        )
    ...
    def test_create_batch_chart_empty_data(self, batch_generator, tmp_path):
        ...
        with pytest.raises(ValueError, match="symbols_data cannot be empty"):
            batch_generator.create_batch_chart(symbols_data=[], timeframe="1h", output_path=str(output_path))
    ...
    def test_create_batch_chart_with_error_symbol(self, batch_generator, sample_ohlcv_data, tmp_path):
        ...
        result_path, truncated = batch_generator.create_batch_chart(
            symbols_data=symbols_data, timeframe="1h", output_path=str(output_path)
        )
    ...
    def test_create_batch_chart_missing_columns(self, batch_generator, tmp_path):
        ...
        symbols_data = [{"symbol": "INVALID/USDT", "df": invalid_df}]
...
class TestChartBatchGeneratorPlotSimpleChart:
    ...
    def test_plot_simple_chart_valid_data(self, batch_generator, sample_ohlcv_data):
        ...
        batch_generator._plot_simple_chart_on_axes(ax=ax, df=sample_ohlcv_data, symbol="BTC/USDT", timeframe="1h")
    ...
    def test_plot_simple_chart_empty_dataframe(self, batch_generator):
        ...
        batch_generator._plot_simple_chart_on_axes(ax=ax, df=empty_df, symbol="BTC/USDT", timeframe="1h")
    ...
    def test_plot_simple_chart_missing_columns(self, batch_generator):
        ...
        batch_generator._plot_simple_chart_on_axes(ax=ax, df=invalid_df, symbol="BTC/USDT", timeframe="1h")
    ...
    def test_plot_simple_chart_single_candle(self, batch_generator):
        ...
        batch_generator._plot_simple_chart_on_axes(ax=ax, df=single_candle, symbol="BTC/USDT", timeframe="1h")
