...
class TestSimpleChartGeneratorInit:
    ...
    def test_init_custom_params(self):
        ...
        generator = SimpleChartGenerator(figsize=(3.0, 2.0), style="default", dpi=150)
...
class TestSimpleChartGeneratorCreateSimpleChart:
    ...
    def test_create_simple_chart_basic(self, simple_generator, sample_ohlcv_data):
        ...
        fig = simple_generator.create_simple_chart(df=sample_ohlcv_data, symbol="BTC/USDT", timeframe="1h")
    ...
    def test_create_simple_chart_with_label(self, simple_generator, sample_ohlcv_data):
        ...
        fig = simple_generator.create_simple_chart(
            df=sample_ohlcv_data, symbol="BTC/USDT", timeframe="1h", show_symbol_label=True
        )
    ...
    def test_create_simple_chart_without_label(self, simple_generator, sample_ohlcv_data):
        ...
        fig = simple_generator.create_simple_chart(
            df=sample_ohlcv_data, symbol="BTC/USDT", timeframe="1h", show_symbol_label=False
        )
    ...
    def test_create_simple_chart_single_candle(self, simple_generator):
        ...
        fig = simple_generator.create_simple_chart(df=single_candle, symbol="BTC/USDT", timeframe="1h")
    ...
    def test_create_simple_chart_symbol_label_formatting(self, simple_generator, sample_ohlcv_data):
        ...
        for text in text_elements:
            ...
            test_points = [(0, 0), (1, 1)]
            is_transaxes = all(
                np.allclose(text_transform.transform(point), ax.transAxes.transform(point)) for point in test_points
            )
            if is_transaxes:
    ...
    def test_create_simple_chart_different_symbols(self, simple_generator, sample_ohlcv_data):
        ...
        for symbol in symbols:
            fig = simple_generator.create_simple_chart(df=sample_ohlcv_data, symbol=symbol, timeframe="1h")
            assert fig is not None
            plt.close(fig)
