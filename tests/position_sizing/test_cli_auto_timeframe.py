...
Tests cover:
- _try_timeframes_auto function- Auto timeframe testing logic
...
class TestTryTimeframesAuto:
    """Test suite for _try_timeframes_auto function"""
    ...
    def test_finds_valid_timeframe_at_first_attempt(self, mock_data_fetcher, sample_symbols, valid_results_df):
        ...
        with patch("modules.position_sizing.cli.main.PositionSizer") as mock_position_sizer_class:
            ...
            timeframe, results = _try_timeframes_auto(
    ...
    def test_finds_valid_timeframe_at_second_attempt(
        self, mock_data_fetcher, sample_symbols, valid_results_df, zero_results_df
    ):
    ...
    def test_finds_valid_timeframe_at_third_attempt(
        self, mock_data_fetcher, sample_symbols, valid_results_df, zero_results_df
    ):
    ...
    def test_calculate_portfolio_allocation_called_with_correct_params(
        self, mock_data_fetcher, sample_symbols, valid_results_df
    ):
...
class TestTryTimeframesAutoLogging:
    ...
    def test_logs_progress_for_each_timeframe(
        self, mock_data_fetcher, sample_symbols, zero_results_df, valid_results_df
    ):
        """Test that function logs progress for each timeframe attempt"""
        with (
            patch("modules.position_sizing.cli.main.PositionSizer") as mock_position_sizer_class,
