...
class TestDecisionMatrixClassifier:
    ...
    def test_calculate_cumulative_vote_all_agree(self):
        ...
        cumulative_vote, weighted_score, breakdown = classifier.calculate_cumulative_vote(threshold=0.5, min_votes=2)
    ...
    def test_calculate_cumulative_vote_below_threshold(self):
        ...
        cumulative_vote, weighted_score, _ = classifier.calculate_cumulative_vote(threshold=0.5, min_votes=1)
    ...
    def test_calculate_cumulative_vote_min_votes_requirement(self):
        ...
        cumulative_vote, weighted_score, _ = classifier.calculate_cumulative_vote(threshold=0.3, min_votes=2)
