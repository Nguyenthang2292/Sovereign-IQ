...
class TestKalmanFilterOHLC:
    ...
    def test_initialization_custom_params(self):
        ...
        kf = KalmanFilterOHLC(
            process_variance=1e-4, observation_variance=0.5, initial_state=100.0, initial_uncertainty=2.0
        )
    ...
    def test_get_params(self):
        ...
        kf = KalmanFilterOHLC(process_variance=1e-4, observation_variance=0.5, initial_state=100.0)
...
class TestApplyKalmanToOHLC:
    ...
    def test_apply_kalman_too_short(self):
        ...
        df = pd.DataFrame({"open": [100, 101], "high": [102, 103], "low": [99, 100], "close": [101, 102]})
...
class TestValidateKalmanParams:
    ...
    def test_validate_valid_params(self):
        ...
        params = {"process_variance": 1e-5, "observation_variance": 1.0, "initial_uncertainty": 1.0}
    ...
    def test_validate_negative_variance(self):
        ...
        params = {"process_variance": -1e-5, "observation_variance": 1.0}
    ...
    def test_validate_zero_variance(self):
        ...
        params = {"process_variance": 0, "observation_variance": 1.0}
        assert validate_kalman_params(params) is False
