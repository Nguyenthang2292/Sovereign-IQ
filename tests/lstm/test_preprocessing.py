...
class TestPreprocessCnnLstmData:
    ...
    def test_missing_close_column(self):
        ...
        X, y, scaler, features = preprocess_cnn_lstm_data(
            df, look_back=10, output_mode='regression'
        )
    ...
    def test_data_with_nan_values(self, sample_ohlcv_data):
        ...
        X, y, scaler, features = preprocess_cnn_lstm_data(
            sample_ohlcv_data, look_back=WINDOW_SIZE_LSTM
        )
    ...
    def test_sequence_creation(self, sample_ohlcv_data):
        ...
        look_back = 30
        X, y, scaler, features = preprocess_cnn_lstm_data(
            sample_ohlcv_data, look_back=look_back
        )
    ...
    def test_error_handling_feature_calculation_failure(self, sample_ohlcv_data):
        ...
        with patch('modules.lstm.utils.preprocessing.generate_indicator_features', 
    ...
    def test_error_handling_target_creation_failure(self, sample_ohlcv_data):
        ...
        with patch('modules.lstm.utils.preprocessing.create_balanced_target', 
                   side_effect=Exception("Target creation error")):
            X, y, scaler, features = preprocess_cnn_lstm_data(
                sample_ohlcv_data,
                look_back=WINDOW_SIZE_LSTM,
                output_mode='classification'
    ...
    def test_error_handling_scaling_failure(self, sample_ohlcv_data):
        ...
        with patch('sklearn.preprocessing.MinMaxScaler.fit_transform', 
                   side_effect=Exception("Scaling error")):
            X, y, scaler, features = preprocess_cnn_lstm_data(
                sample_ohlcv_data, look_back=WINDOW_SIZE_LSTM
            )
    ...
    def test_minimum_data_requirement(self, minimal_ohlcv_data):
        ...
        X, y, scaler, features = preprocess_cnn_lstm_data(
            minimal_ohlcv_data, look_back=30
        )
    ...
    def test_large_look_back(self, sample_ohlcv_data):
        ...
        large_look_back = 100
        X, y, scaler, features = preprocess_cnn_lstm_data(
            sample_ohlcv_data, look_back=large_look_back
        )
