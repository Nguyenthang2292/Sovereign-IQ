...
class TestCNN1DExtractor:
    ...
    def test_init_custom_kernel_sizes(self):
        ...
        extractor = CNN1DExtractor(input_channels=10, cnn_features=64, kernel_sizes=[3, 5], dropout=0.3)
    ...
    def test_forward_single_kernel_size(self):
        ...
        extractor = CNN1DExtractor(input_channels=10, cnn_features=64, kernel_sizes=[3], dropout=0.3)
        x = torch.randn(2, 50, 10)
        output = extractor(x)
        assert output.shape == (2, 50, 64)
    ...
    def test_forward_many_kernel_sizes(self):
        ...
        extractor = CNN1DExtractor(input_channels=10, cnn_features=64, kernel_sizes=[3, 5, 7, 9, 11], dropout=0.3)
        x = torch.randn(2, 50, 10)
        output = extractor(x)
        assert output.shape == (2, 50, 64)
    ...
    def test_has_batch_norm_layers(self):
        ...
        extractor = CNN1DExtractor(input_channels=10, cnn_features=64, dropout=0.3)
        batch_norm_found = any(isinstance(m, torch.nn.BatchNorm1d) for m in extractor.modules())
