...
class TestInputValidation:
    ...
    @pytest.mark.parametrize("invalid_input_size,error_msg", [
    ...
    @pytest.mark.parametrize("invalid_look_back,error_msg", [
    ...
    @pytest.mark.parametrize("model_config,expected_error", [
        (
            {"use_attention": True, "invalid_param": 123},
            "Unknown parameters for LSTM-Attention model"
        ),
        (
        ...
        (
            {"use_cnn": True, "invalid_param": 123},
            "Unknown parameters for CNN-LSTM-Attention model"
        ),
    ])
...
class TestForwardPass:
    ...
    @pytest.mark.parametrize("model_name,config,seq_len", [
