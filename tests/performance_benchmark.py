...
def compare_test_performance():
    ...
    tests_to_run = [
        ...
        {
            'command': 'python -m pytest tests/range_oscillator/test_strategy.py::TestStrategy1::test_strategy1_basic -v --tb=no',
            'description': 'Original slow test'
        },
        
        # Optimized test approach  
        {
            'command': 'python -m pytest tests/range_oscillator/test_strategy_optimized.py::TestRangeOscillatorOptimized::test_strategy_basic_fast -v --tb=no',
            'description': 'Optimized fast test'
        },
        
        # Multiple optimized tests
        {
            'command': 'python -m pytest tests/range_oscillator/test_strategy_optimized.py::TestRangeOscillatorOptimized::test_strategy_parametrized_fast -v --tb=no',
            'description': 'Parameterized optimized tests'
        },
        
        # Edge case optimized tests
        {
            'command': 'python -m pytest tests/range_oscillator/test_strategy_optimized.py::TestRangeOscillatorOptimized::test_strategy_edge_cases_fast -v --tb=no',
    ...
    if successful_results:
        ...
        if len(successful_results) > 1:
            ...
            print(f"📈 Time Saved: {baseline_time - fastest_time:.2f}s ({(1-fastest_time/baseline_time)*100:.1f}%)")
    ...
    if successful_results:
        ...
        print(f"✅ Consider adopting this pattern for other tests")
