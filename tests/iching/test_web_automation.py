...
class TestFillWebForm:
    ...
    @patch('modules.iching.core.web_automation.WebDriverWait')
    def test_fill_web_form_success(self, mock_wait_class, mock_ensure, mock_clear, 
                                   mock_handle, mock_submit, mock_screenshot, mock_webdriver):
    ...
    def test_fill_web_form_continue_on_error(self, mock_log_error, mock_wait_class, 
                                             mock_ensure, mock_clear, mock_handle, 
                                             mock_submit, mock_screenshot, mock_webdriver):
    ...
    @patch('modules.iching.core.web_automation.WebDriverWait')
    @patch('modules.iching.core.web_automation.log_error')
    def test_fill_web_form_stop_on_error(self, mock_log_error, mock_wait_class, 
                                        mock_ensure, mock_clear, mock_handle, 
                                        mock_submit, mock_screenshot, mock_webdriver):
