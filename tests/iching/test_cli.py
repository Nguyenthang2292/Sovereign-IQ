...
class TestMain:
    ...
    def test_main_success(self, mock_log_error, mock_log_info, mock_clean, mock_prepare, mock_fill):
    ...
    @patch("modules.iching.cli.main.log_error")
    @patch("sys.exit")
    def test_main_clean_error(self, mock_exit, mock_log_error, mock_log_info, mock_clean, mock_prepare, mock_fill):
        ...
        assert not any(
            "Đã xóa" in str(call) or "Folder images đã sạch" in str(call) for call in mock_log_info.call_args_list
        )
    ...
    def test_main_prepare_error(
        self, mock_traceback, mock_exit, mock_log_error, mock_log_info, mock_clean, mock_prepare, mock_fill
    ):
    ...
    @patch("modules.iching.cli.main.log_error")
    @patch("sys.exit")
    def test_main_fill_error(self, mock_exit, mock_log_error, mock_log_info, mock_clean, mock_prepare, mock_fill):
    ...
    @patch("modules.iching.cli.main.clean_images_folder")
    @patch("modules.iching.cli.main.log_info")
    def test_main_with_deleted_files(self, mock_log_info, mock_clean, mock_prepare, mock_fill):
