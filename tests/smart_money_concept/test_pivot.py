...
class TestPivotInitialization:
    ...
    def test_custom_initialization(self):
        ...
        pivot = Pivot(level=50000.0, bar_time=test_time, pivot_type="support", strength=5, pip_size=0.01)
...
class TestPivotIntegration:
    ...
    def test_full_workflow(self):
        ...
        recent_time = datetime.now(timezone.utc) - timedelta(days=5)
        pivot = Pivot(level=50000.0, bar_time=recent_time, pivot_type="support", strength=5)
