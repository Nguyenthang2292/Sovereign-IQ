...
def test_select_pairs_for_symbols_no_match():
    ...
    pairs_df = pd.DataFrame({"long_symbol": ["BTC/USDT"], "short_symbol": ["ETH/USDT"], "score": [0.9]})
...
def test_select_pairs_for_symbols_max_pairs():
    ...
    selected = select_pairs_for_symbols(pairs_df, ["BTC/USDT", "ETH/USDT", "SOL/USDT"], max_pairs=2)
