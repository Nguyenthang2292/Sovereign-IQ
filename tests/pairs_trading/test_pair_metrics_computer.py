...
def test_compute_pair_metrics_collects_all_sources(monkeypatch):
    monkeypatch.setattr(
        "modules.pairs_trading.core.pair_metrics_computer.calculate_ols_hedge_ratio",
        lambda p1, p2, fit_intercept=True: 2.0,
    )
    monkeypatch.setattr(
        "modules.pairs_trading.core.pair_metrics_computer.calculate_adf_test",
        lambda spread, min_points: {"adf_pvalue": 0.02},
    )
    monkeypatch.setattr(
        "modules.pairs_trading.core.pair_metrics_computer.calculate_half_life",
        lambda spread: 15.0,
    )
    monkeypatch.setattr(
        "modules.pairs_trading.core.pair_metrics_computer.calculate_zscore_stats",
    ...
    monkeypatch.setattr(
        "modules.pairs_trading.core.pair_metrics_computer.calculate_hurst_exponent",
    ...
    monkeypatch.setattr(
        "modules.pairs_trading.core.pair_metrics_computer.calculate_max_drawdown",
        lambda spread: -0.2,
    )
    monkeypatch.setattr(
        "modules.pairs_trading.core.pair_metrics_computer.calculate_calmar_ratio",
        lambda spread, periods: 1.1,
    )
    monkeypatch.setattr(
        "modules.pairs_trading.core.pair_metrics_computer.calculate_johansen_test",
    ...
    monkeypatch.setattr(
        "modules.pairs_trading.core.pair_metrics_computer.calculate_kalman_hedge_ratio",
        lambda p1, p2, delta=1e-5, observation_covariance=1.0: 1.8,
    )
    monkeypatch.setattr(
        "modules.pairs_trading.core.pair_metrics_computer.calculate_direction_metrics",
