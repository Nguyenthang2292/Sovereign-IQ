...
def test_calculate_combined_confidence_disabled():
    ...
    with patch("modules.hmm.signals.confidence.HMM_FEATURES", {"combined_confidence_enabled": False}):
        ...
        combined = calculate_combined_confidence(high_order_prob, kama_confidence, signal_agreement)
...
def test_calculate_combined_confidence_enabled():
    ...
    expected_base = high_order_prob * HMM_HIGH_ORDER_WEIGHT + kama_confidence * HMM_KAMA_WEIGHT
...
def test_calculate_combined_confidence_with_agreement():
    ...
    combined_with_agreement = calculate_combined_confidence(high_order_prob, kama_confidence, signal_agreement)

    combined_without_agreement = calculate_combined_confidence(high_order_prob, kama_confidence, False)
