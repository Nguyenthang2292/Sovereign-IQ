...
SPC_AGGREGATION_WEIGHTED_MIN_TOTAL = 0.33  # Minimum total weight required for signal (reduced from 0.5 to accept single strong strategy)
...
SPC_AGGREGATION_SIMPLE_MIN_ACCURACY_TOTAL = 0.65  # Minimum total accuracy for simple mode (reduced from 1.5 to accept single strategy)
