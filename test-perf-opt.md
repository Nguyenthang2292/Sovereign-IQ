...
- [x] **T1 – pytest.ini: add 3 new markers, bump `--durations`**
...
- [x] **T2 – `test_health.py::test_check_timeout` — remove real `time.sleep(5)`**
...
- [x] **T3 – `test_scan_cache.py` TTL tests — eliminate `time.sleep` sleeps up to 2.1 s total**
...
- [x] **T4 – `test_adaptive_close.py::test_fallback_no_data` — patch `_fetch_ohlcv`**
...
- [x] **T5 – `test_data_service.py` — fix fallback test + mark non-integration**
...
- [x] **T6 – `test_backtest_phase6.py` — smoke profile + layer markers**
...
- [x] **T7 – `test_gemini_integration.py` — module-scoped heavy init fixture**
...
- [x] **T8 – Add PR & nightly commands to `run_tests.ps1` / `run_tests.bat`**
