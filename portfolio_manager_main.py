...
def main():
    ...
    if var_value is not None:
        ...
        print(
            color_text(
                f"Interpretation: With {conf_pct}% confidence, daily loss should stay within {var_value:.2f} USDT.",
                Fore.WHITE,
            )
        )
    else:
        print(
            color_text(
                "VaR Interpretation: Not enough history for a reliable estimate.",
                Fore.YELLOW,
            )
        )
